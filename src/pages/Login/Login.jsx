    ...
    <div className='login'>
      ...
      <div className="login-form">
        ...
        <div className="form-switch">
          {signState==="Sign Up"?<p>Already Have Account? <span onClick={changeSignState}>Sign In Now</span></p>:<p>New to Netflix? <span onClick={changeSignState}>Sign Up Now</span></p>}
